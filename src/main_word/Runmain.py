...
@author: uidp4235
'''
from common.read_testcase import GetExcel
...
class Runmain:
    ...
    def runmain(self, i):
        ...
        while (n<cycle):
            ...
            if n == 1 or conditon.find('repeat_ab') == -1:
                    ...
                    if element == None and handle_value ==None:
                        ...
                        if expect_element != None:
                            if expect_handle == 'check' or expect_handle == 'sound_check':
                                expect_result = getattr(Action, expect_handle)   # Mei Xiu 20200225 返回action_method文件中的check/sound_check方法
                                print('expect_result is ', expect_result)
                                result = expect_result(expect_element)  # Mei Xiu 20200225 check期望结果中的元素或者sound是否存在
